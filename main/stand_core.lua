...
local Utils = getgenv().StandUtils
local Players = Utils.Players
local RunService = Utils.RunService
local ReplicatedStorage = Utils.ReplicatedStorage
local Workspace = Utils.Workspace
local Stats = Utils.Stats
local getLp = Utils.getLp
local getMouse = Utils.getMouse
local normalizeName = Utils.normalizeName
local ConnectionManager = Utils.ConnectionManager
local getChar = Utils.getChar
local getRoot = Utils.getRoot
local getHumanoid = Utils.getHumanoid
local getPingSeconds = Utils.getPingSeconds
local getPartVelocity = Utils.getPartVelocity
local resolvePlayer = Utils.resolvePlayer
local getDetectorAndHead = Utils.getDetectorAndHead
local fireDetector = Utils.fireDetector
